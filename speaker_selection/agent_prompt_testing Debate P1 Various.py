...
chat_messages=[
    ...
    {
        'role': 'system',
        'content': "Read the above conversation. Then select the next role from ['Debate_Moderator_Agent', 'Affirmative_Constructive_Debater', 'Negative_Constructive_Debater', 'Affirmative_Rebuttal_Debater', 'Negative_Rebuttal_Debater', 'Debate_Judge'] to play. RETURN ONLY THE NAME OF THE ROLE. Output in plain text.",
    },
]

# print(chat_messages)

models = ["phi:latest"] #"yi:34b-chat-q3_K_M", "mixtralcopy", "llama2:13b-chat", "mistral:7b-instruct-q6_K", "neural-chat:7b-v3.3-q6_K", "openhermes:7b-mistral-v2.5-q6_K", "orca2:13b-q5_K_S", "solar:10.7b-instruct-v1-q5_K_M", "qwen:14b-chat-q6_K"]
